<?php
	...
	/* This script will perform the autocomplete for the main search box. When a user begins typing a search query, this script will be called to check the emerging query term against the database, and will return a JSON object containing any matching tag names */
